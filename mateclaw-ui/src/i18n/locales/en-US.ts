export default {
  ...
  agents: {
    ...
    binding: {
      ...
      kbKicker: 'Knowledge sources',
      kbTagline: 'A knowledge base is a collection of structured documents. The agent retrieves content via Wiki tools to answer questions.',
      kbHint: 'Select knowledge bases this agent can use. Without any selection, Wiki features will be unavailable.',
  ...
  wiki: {
    ...
    deleteKBConfirm: 'Are you sure you want to delete knowledge base "{name}"? This cannot be undone.',
